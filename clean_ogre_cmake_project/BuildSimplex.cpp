...
class BuildSimplex{
	...
	public:
		BuildSimplex(double size, float frequency, float amplitude, unsigned octaves);
...
BuildSimplex::BuildSimplex(double size, float frequency = .00002f, float amplitude = 10.0f, unsigned octaves = 16.0) {
        //get the command line arguments
	unsigned i;
        unsigned xgrid = (unsigned) size;
        unsigned ygrid = (unsigned) size;
        unsigned zgrid = 500;
        //unsigned octaves = 16;
