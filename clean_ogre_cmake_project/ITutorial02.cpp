...
void ITutorial02::configureTerrainDefaults(Ogre::Light* light)
{
    ...
    textureData *texdat = new textureData(std::string("Texture"),2,1,0,&matexfn, &ntexname, &ntexid, 0, &nmatexfn);  //found in TerrainTexturesNode.cpp
    ...
    defaultimp.layerList[2].textureNames.push_back("Texture");//growth_weirdfungus-03_diffusespecular.dds");
    defaultimp.layerList[2].textureNames.push_back("TextureNormal"); 
    //*/
