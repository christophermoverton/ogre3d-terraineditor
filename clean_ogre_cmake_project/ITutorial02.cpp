...
{
    img.load("test6.png", Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME);
    if (flipX)
        img.flipAroundY();
    if (flipY)
        img.flipAroundX();
...
//-------------------------------------------------------------------------------------
void ITutorial02::initBlendMaps(Ogre::Terrain* terrain, int wterrid)
{
    Ogre::TerrainLayerBlendMap* blendMap0 = terrain->getLayerBlendMap(1);
    Ogre::TerrainLayerBlendMap* blendMap1 = terrain->getLayerBlendMap(5);
    ...
    float val1 = 0.0f;  float val2 = 1.0f;
    std::vector<float> val(4);
    if (wterrid == 0){
	val[0] = 1.0f; val[1] = 0.0f; val[2] = 0.0f; val[3] = 0.0f;
    }
    else if (wterrid == 1){
	val[0] = 0.0f; val[1] = 1.0f; val[2] = 0.0f; val[3] = 0.0f;
    }
    else if (wterrid == 2){
	val[0] = 0.0f; val[1] = 0.0f; val[2] = 0.0f; val[3] = 1.0f;
    }
    else {
	val[0] = 0.0f; val[1] = 0.0f; val[2] = 1.0f; val[3] = 0.0f;
    }
...
void ITutorial02::configureTerrainDefaults(Ogre::Light* light)
{
    ...
    // textures
    Ogre::Image imageOgre4;
    imageOgre4.load("test10.png", Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME);
    ...
    Ogre::TexturePtr m_texture4;
    Ogre::TexturePtr m_texture5;
    Ogre::TexturePtr m_texture6;
    Ogre::TexturePtr m_texture7;
    Ogre::TexturePtr m_texture8;
    Ogre::TexturePtr m_texture9;
    ...
    m_texture3 = Ogre::TextureManager::getSingletonPtr()->createManual(
                ...
                0,
                Ogre::PF_R8G8B8A8, Ogre::TU_DYNAMIC_WRITE_ONLY_DISCARDABLE);
    m_texture4 = Ogre::TextureManager::getSingletonPtr()->createManual(
                "Terrain2",
                Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
                Ogre::TEX_TYPE_2D,
                imageOgre.getWidth(),
                ...
                0,
                Ogre::PF_R8G8B8A8, Ogre::TU_DYNAMIC_WRITE_ONLY_DISCARDABLE);
    m_texture5 = Ogre::TextureManager::getSingletonPtr()->createManual(
                "Terrain2Normal",
                Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
                Ogre::TEX_TYPE_2D,
                imageOgre.getWidth(),
                ...
                0,
                Ogre::PF_R8G8B8A8, Ogre::TU_DYNAMIC_WRITE_ONLY_DISCARDABLE);
    m_texture6 = Ogre::TextureManager::getSingletonPtr()->createManual(
                "Terrain3",
                Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
                Ogre::TEX_TYPE_2D,
                imageOgre.getWidth(),
                ...
                0,
                Ogre::PF_R8G8B8A8, Ogre::TU_DYNAMIC_WRITE_ONLY_DISCARDABLE);
    m_texture7 = Ogre::TextureManager::getSingletonPtr()->createManual(
                "Terrain3Normal",
                Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
                Ogre::TEX_TYPE_2D,
                imageOgre.getWidth(),
                ...
                0,
                Ogre::PF_R8G8B8A8, Ogre::TU_DYNAMIC_WRITE_ONLY_DISCARDABLE);
    m_texture8 = Ogre::TextureManager::getSingletonPtr()->createManual(
                "Terrain4",
                Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
                Ogre::TEX_TYPE_2D,
                imageOgre.getWidth(),
                ...
                0,
                Ogre::PF_R8G8B8A8, Ogre::TU_DYNAMIC_WRITE_ONLY_DISCARDABLE);
    m_texture9 = Ogre::TextureManager::getSingletonPtr()->createManual(
                "Terrain4Normal",
                Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
                Ogre::TEX_TYPE_2D,
                imageOgre.getWidth(),
    ...
    std::string ntexname("TextureNormal"); int ntexid = 2;
    textureData *texdat = new textureData(std::string("Texture"),3,1,0,&matexfn, &ntexname, &ntexid, 0, &nmatexfn);  //found in TerrainTexturesNode.cpp
    ...
    delete &imageOgre3;
    ///*
    m_texture5->loadImage(imageOgre);
    m_texture7->loadImage(imageOgre);
    m_texture9->loadImage(imageOgre);
    m_texture4->loadImage(imageOgre4);
    m_texture6->loadImage(imageOgre4);
    m_texture8->loadImage(imageOgre4);
    //*/
    /*
    m_texture5->copyToTexture(m_texture);
    m_texture7->copyToTexture(m_texture);
    m_texture9->copyToTexture(m_texture);
    m_texture4->copyToTexture(pResource3);
    m_texture6->copyToTexture(pResource3);
    m_texture8->copyToTexture(pResource3);
    //*/
    delete &imageOgre;
    delete &imageOgre4;
    ...
    defaultimp.layerList[1].textureNames.push_back("TerrainNormal");
    ///*
    defaultimp.layerList[5].worldSize = 200;//200;
    defaultimp.layerList[5].textureNames.push_back("Texture");//growth_weirdfungus-03_diffusespecular.dds");
    defaultimp.layerList[5].textureNames.push_back("TextureNormal");

    defaultimp.layerList[2].worldSize = 12000;
    defaultimp.layerList[2].textureNames.push_back("Terrain2");//grass_green-01_diffusespecular.dds");
    defaultimp.layerList[2].textureNames.push_back("Terrain2Normal"); 

    defaultimp.layerList[3].worldSize = 12000;
    defaultimp.layerList[3].textureNames.push_back("Terrain3");//grass_green-01_diffusespecular.dds");
    defaultimp.layerList[3].textureNames.push_back("Terrain3Normal");

    defaultimp.layerList[4].worldSize = 12000;
    defaultimp.layerList[4].textureNames.push_back("Terrain4");//grass_green-01_diffusespecular.dds");
    defaultimp.layerList[4].textureNames.push_back("Terrain4Normal");
    //*/
...
//  Ogre::MaterialManager::getSingleton().setDefaultAnisotropy(7);
    ...
    Ogre::Image img;
    img.load("test6.png", Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME);
	m_texture3->loadImage(img);
    delete &imageOgre;
    delete &imageOgre2;
    delete &img;
        renderMaterial->getTechnique(0)->getPass(0)->createTextureUnitState("Terrain"); 
    ...
    std::string ntexname("TerrainNormal"); int ntexid = 2;
    /*
    ...
    textureData *texdat = new textureData(std::string("Terrain"),1,1,0,&matexfn, &ntexname, &ntexid, 0, &nmatexfn);  //found in TerrainTexturesNode.cpp
    TerrainTexturesNode::Instance()->setTextureNode(*texdat);  //Application non ogre singleton class...use to register terrain textures..
    textureData *texdat2 = new textureData(std::string("Continent"),2,1,0,&matexfn, &ntexname, &ntexid, 0, &nmatexfn);  //found in TerrainTexturesNode.cpp
    TerrainTexturesNode::Instance()->setTextureNode(*texdat2);  //Application non ogre singleton class...use to register terrain textures..
...
//        {
	for (int g = 0; g<3; g++){
	   for(int h = 0; h<3; h++){
	     Ogre::Terrain* t = mTerrainGroup->getTerrain(g,h);
...
CEGUI::Key::Scan convertKey(const OIS::KeyEvent& arg)
{
    switch (arg.key)
    {
    case OIS::KC_C:
...
//need keyboard input injection virtual bool CEGUI::InjectedInputReceiver::injectKeyUp	(	Key::Scan 	scan_code	)	
...
{
	//CEGUI::System::getSingleton().getDefaultGUIContext().injectKeyDown(convertKey(arg));
	CEGUI::System::getSingleton().getDefaultGUIContext().injectKeyDown((CEGUI::Key::Scan)arg.key);
	CEGUI::System::getSingleton().getDefaultGUIContext().injectChar(arg.text);	
        //first prevent key entry while the mouse is hovering over cegui window.
        CEGUI::Window *newWindow = CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("TerrainWindow");
	CEGUI::Window *newWindow2 = CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("FluidErosionWindow");
	CEGUI::Vector2<float> mousePos = CEGUI::System::getSingleton().getDefaultGUIContext().getMouseCursor().getPosition();
