...
now balanced and references the grandparent node which is what is desired for the deletion event.  Whenever p1 parabola on the given
...
the subtree then occurs when, in theory p3 occupies all three leaf nodes (as a conditional check).  
