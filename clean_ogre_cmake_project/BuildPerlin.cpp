#ifndef __BuildPerlin_CPP
#define __BuildPerlin_CPP
#include <math.h>
...
double marble_noise(double x, double y, double z, Vector origin, double size, 
                    int shape, int bias, int sharpnes, double turb, double depth, double frequency );
terr::CPointsMap  pmarblebuild (double size, double scale, double frequency, double amplitude, double octaves, double gain);
...
double marble_noise(double x, double y, double z, Vector origin, double size, 
    ...
    //}
    h = mg_fBm(x,y,z,0.8f, 2.0f, depth, 0);
...
terr::CPointsMap  pmarblebuild (double size, double scale, double frequency, double amplitude, double octaves, double gain){
   ...
   for (int i = 0; i < size; i++){
	for (int j = 0; j < size; j++){
		...
		val = marble_noise( x, y, z, origin, scale, 0, 0, 0, amplitude, octaves, frequency);
